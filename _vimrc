...
if g:isWIN
    ...
    " set tags+=D:/Ruchee/workspace/Apps/php/sf2_primer/vendor/symfony/tags
    " set tags+=D:/Ruchee/workspace/Apps/php/sf2_primer/vendor/twig/tags
    " set tags+=D:/Ruchee/workspace/Apps/php/sf2_primer/vendor/doctrine/tags
    " set tags+=D:/Ruchee/workspace/Apps/php/sf2_primer/src/tags

    " set path+=D:/Ruchee/MinGW/include
    " set path+=D:/Ruchee/MinGW/include/c++/4.8.1
else
...
" 设置缩进策略，并对部分语言设置单独的缩进
set shiftwidth=4
set tabstop=4

au FileType ruby,eruby,coffee,sass,cucumber,scheme,lisp,clojure set shiftwidth=2
au FileType ruby,eruby,coffee,sass,cucumber,scheme,lisp,clojure set tabstop=2
...
let g:vimwiki_valid_html_tags = 'a,b,i,s,u,sub,sup,br,hr,div,del,code,red,center,left,right,h1,h2,h3,h4,h5,h6,pre,script,style'
